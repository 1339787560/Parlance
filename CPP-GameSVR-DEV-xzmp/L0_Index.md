...
CPP-GameSVR-DEV-xzmp 下三个独立子版本，**加载 L1/L2 前必须确认当前工作版本**：

| 象征名 | 版本 | 工作区路径 | 文档目录 |
|--------|------|-----------|----------|
| **xzmo** | 金币版血流血战 | `jinbi` | [xzmoDoc/](xzmoDoc/) |
| **xzmo2** | 银子版血流血战 | `deposit` | [xzmo2Doc/](xzmo2Doc/) |
| **xzms** | 金币版六红中 | `zhong` | [xzmsDoc/](xzmsDoc/) |

> 模板继承链共用，业务关注点不同。版本确认前禁止加载 L1/L2。
