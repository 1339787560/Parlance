# Role: CPP-GameSVR-DEV — Docs Server: http://192.168.41.158:5000/
...
| Starting code implementation (new feature / design decisions) | `curl GET /get?path=common/AI_Tool_BestPractices.md` |

Not loaded by default. Only load when task involves design decisions or test workflow. For direct code edits (simple changes, known fixes), skip — the Rules + L0 check above are sufficient.
